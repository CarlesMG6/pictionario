...
export class GameLogic {
  static async success(room_id: string) {
    console.log('Success called for room:', room_id);
  ...
  static async fail(room_id: string) {
    console.log('Fail called for room:', room_id);
